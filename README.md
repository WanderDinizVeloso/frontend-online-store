...
Projeto desenvolvido durante o Curso de Desenvolvimento WEB, Turma 12, da [trybe](https://www.betrybe.com/), onde desenvolvi minhas habilidades em JavaScript, React.js, Metologias Ágeis, Scrum, Kanban e muita softs skills, na criação de uma pagina de compras online.

Obs.: Projeto desenvolvido em Grupo.

Membros do meu Grupo:
 - [Ryan Laiber](https://github.com/ryanlaiber);
 - [Eric Kreis](https://github.com/eric-kreis);
 - [Igor Fernandes](https://github.com/srsifer);
 - [Augusto Mourão](https://github.com/August0CM).
